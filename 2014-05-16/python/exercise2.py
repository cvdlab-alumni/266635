...
color_pal = myColor(247,192,129)

n_appartamenti = [T(3)(3),final]

mio_palazzo = STRUCT(NN(7)(n_appartamenti))

mio_palazzo = COLOR (color_pal)(mio_palazzo)

VIEW(mio_palazzo)

base = CUBOID([15,15,2])

base = T([1,2,3])([8,2,1])(base)

color_base = myColor(178,178,178)

base_palazzo = STRUCT([mio_palazzo,base])

base_palazzo = COLOR(color_base)(base_palazzo)
...
bez_traslata = T([1,2,3])([20.5,4.5,3]) (bez_3_mapped)

VIEW(bez_traslata)

final = STRUCT([base_palazzo,bez_traslata])

VIEW(final)

tetto = CUBOID([15,15,1])

tetto = T([1,2,3])([8,2,24])(tetto)

final = STRUCT([base_palazzo,bez_traslata,tetto])

VIEW(final)

copertura = CUBOID([3,3,21])

copertura = T([1,2,3])([13,2,3])(copertura)

final = STRUCT([base_palazzo,bez_traslata,tetto,copertura])
